...
const TableBase = (props: TableBaseProps) => {
	const { modelName, Form, title, dependencies = [], params, buttons, widthDrawer, destroyModal, otherProps } = props;
	...
	useEffect(() => {
		getData(params);
	}, [...dependencies, filters, condition, sort, otherProps?.page, otherProps?.limit]);
